...
export namespace $default {
  ...
  export interface UserSession extends std.$Object {
    "isActive": boolean;
    "sessionToken": string;
...
export interface types {
  ...
  "default": {
    "AuditLog": $default.AuditLog;
    "Permission": $default.Permission;
    "Role": $default.Role;
    "User": $default.User;
    "UserSession": $default.UserSession;
  };
  "schema": {
